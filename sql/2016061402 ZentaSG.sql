...
--
-- Host: localhost
-- Generation Time: Jun 14, 2016 at 10:41 PM
...
-- Database: `zentasg`
--
CREATE DATABASE IF NOT EXISTS `zentasg` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `zentasg`;
...
CREATE TABLE IF NOT EXISTS `actividades` (
  ...
  `hh_estimadas` int(11) NOT NULL,
  `hh_reales` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `area_proyecto` (
  `area_proyecto_id` int(11) NOT NULL AUTO_INCREMENT,
  `hh_asignadas` int(11) NOT NULL,
  `proy_id` int(11) NOT NULL,
  `area_id` int(11) NOT NULL,
  PRIMARY KEY (`area_proyecto_id`),
  KEY `area_area_proyecto_fk` (`area_id`),
  KEY `proyecto_area_proyecto_fk` (`proy_id`)
...
INSERT INTO `bloques` (`id`, `usuario_id`, `horas`, `fecha`, `orden`) VALUES
(3, 2, 2, '2016-06-14', 2);

-- --------------------------------------------------------

--
-- Table structure for table `bolsa_hh`
--

CREATE TABLE IF NOT EXISTS `bolsa_hh` (
  `blsa_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bolsa_hh`
--
...
INSERT INTO `personas` (`rut`, `user_id`, `apellido_paterno`, `correo`, `apellido_materno`, `nombres`, `hh_mensuales`) VALUES
('11111111', 3, 'Silva', 'jorge.silva@zentagroup.com', 'Aguilera', 'Jorge', 180),
('180325425', 2, 'San Martín', 'orlando.sanmartin@zentagroup.com', 'Carreño', 'Orlando', 90),
('222222222', 5, 'Cociña', 'jorge.cocina@zentagroup.com', 'Pacheco', 'Jorge', 180),
('333333333', 4, 'Silva', 'sebastian.silva@zentagroup.com', 'Carrasco', 'Sebastián', 180),
('444444444', 1, 'Jara', 'miguel.jara@zentagroup.com', 'Orozco', 'Miguel', 180);
...
CREATE TABLE IF NOT EXISTS `persona_proyecto` (
  `prsn_proy_id` int(11) NOT NULL AUTO_INCREMENT,
  `rut` varchar(40) CHARACTER SET utf8 NOT NULL,
  `proy_id` int(11) NOT NULL,
  `activo` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`prsn_proy_id`),
  KEY `rut` (`rut`),
  KEY `proy_id` (`proy_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
--
-- Table structure for table `persona_semana`
--

CREATE TABLE IF NOT EXISTS `persona_semana` (
  `prsn_smna_id` int(11) NOT NULL AUTO_INCREMENT,
  `rut` varchar(40) CHARACTER SET utf8 NOT NULL,
  `area_id` int(11) NOT NULL,
  `fecha_inicio_semana` date NOT NULL,
  `hh_total_asignadas` float NOT NULL,
  `hh_total_porcentaje_asignadas` int(11) NOT NULL,
  PRIMARY KEY (`prsn_smna_id`),
  KEY `rut` (`rut`),
  KEY `area_persona_proyecto_fk` (`area_id`)
...
CREATE TABLE IF NOT EXISTS `proyecto` (
  ...
  PRIMARY KEY (`proy_id`),
  KEY `proyecto_bolsaHh_fk` (`blsa_id`),
  KEY `proy_color` (`proy_color`)
...
--
-- Table structure for table `proyecto_persona_semana`
--

CREATE TABLE IF NOT EXISTS `proyecto_persona_semana` (
  `proy_ps_id` int(11) NOT NULL AUTO_INCREMENT,
  `prsn_smna_id` int(11) NOT NULL,
  `proy_id` int(11) NOT NULL,
  `hh_porcentaje_asignadas` int(11) NOT NULL,
  PRIMARY KEY (`proy_ps_id`),
  KEY `proy_id` (`proy_id`),
  KEY `prsn_smna_id` (`prsn_smna_id`)
...
(201, 2, '06e3ac7fcfdf3b6676127aef228fdaaf', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36', 1465903773),
(202, 3, '36389fded5c6683c65be29fb23869cb5', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36', 1465903928),
(203, 5, '0fd71d376404a31d5589934a377b6b25', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36', 1465904236),
(204, 3, '36389fded5c6683c65be29fb23869cb5', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36', 1465905965),
(205, 3, '36389fded5c6683c65be29fb23869cb5', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36', 1465905995),
(206, 1, '6c1c0e94f48d355c3e2e82efc1bfd3ae', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36', 1465913660),
(207, 2, '06e3ac7fcfdf3b6676127aef228fdaaf', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36', 1465954543);
...
(201, 2, '181.163.59.173', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36'),
(202, 3, '181.163.59.173', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36'),
(203, 5, '181.163.59.173', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36'),
(204, 3, '181.163.59.173', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36'),
(205, 3, '190.46.32.136', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36'),
(206, 1, '190.47.252.127', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36'),
(207, 2, '190.113.31.138', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36');
...
INSERT INTO `users` (`id`, `name`, `email`, `avatar`, `password`, `mustChangePassword`, `profilesId`, `banned`, `suspended`, `active`) VALUES
(1, 'Miguelo Jara Orozco', 'miguel.jara@zentagroup.com', 'files/avatars/1/avatarMiguelo1.jpg', '$2a$08$uO0vuzBiZ5AEozInRS09qevdJtVB0VvWSM90fIXgv0gJxQdcV03wG', 'N', '56b25b7580bf27ec1900002b', 'N', 'N', 'Y'),
(2, 'Orlando San Martín', 'orlando.sanmartin@zentagroup.com', NULL, '$2a$08$uO0vuzBiZ5AEozInRS09qevdJtVB0VvWSM90fIXgv0gJxQdcV03wG', 'N', '0', 'N', 'N', 'Y'),
(3, 'Jorge Silva Aguilera', 'jorge.silva@zentagroup.com', NULL, '$2a$08$uO0vuzBiZ5AEozInRS09qevdJtVB0VvWSM90fIXgv0gJxQdcV03wG', 'N', '0', 'N', 'N', 'Y'),
(4, 'Jorge Cociña Pacheo', 'jorge.cocina@zentagroup.com', NULL, '$2a$08$uO0vuzBiZ5AEozInRS09qevdJtVB0VvWSM90fIXgv0gJxQdcV03wG', 'N', '0', 'N', 'N', 'Y'),
(5, 'Sebastián Silva Carrasco', 'sebastian.silva@zentagroup.com', NULL, '$2a$08$uO0vuzBiZ5AEozInRS09qevdJtVB0VvWSM90fIXgv0gJxQdcV03wG', 'N', '0', 'N', 'N', 'Y');
...
ALTER TABLE `actividades`
  ADD CONSTRAINT `fk_actividadesBloques` FOREIGN KEY (`bloque_id`) REFERENCES `bloques` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `area_proyecto`
--
...
ALTER TABLE `personas`
  ADD CONSTRAINT `fk_userPersona` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `persona_semana`
--
...
--
-- Constraints for table `proyecto_persona_semana`
--
